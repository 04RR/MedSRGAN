...
class Discriminator(nn.Module):
    def __init__(self, in_channels=3, pair=True):
        super().__init__()
        ...
        self.block_1_1 = D_Block(64, 64, stride=1)  # stride= 2 if output 4x
        ...
        self.block_2_1 = D_Block(64, 128, stride=1)
    ...
    def forward(self, x1, x2):
        ...
        x_2 = self.block_2_1(self.conv_2_1(x2))
